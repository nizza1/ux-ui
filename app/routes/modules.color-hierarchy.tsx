  ...
  return (
    <div className="min-h-screen bg-(--bg-primary)">
      ...
      <div className="max-w-2xl mx-auto px-4 pb-8 sm:px-6">
        <LearningGoals>
          <li>Verstehen, wie Farbe die Aufmerksamkeit des Nutzers lenkt — und wie du das gezielt einsetzt</li>
          <li>Die Hierarchie-Pyramide für Aktionen anwenden: Primary → Secondary → Tertiary</li>
          <li>Destruktive Aktionen richtig einordnen — nicht immer rot und fett</li>
          <li>Die „Grauton-zuerst"-Strategie kennen: Farbe sparsam und gezielt einsetzen</li>
          <li>Semantische Farbzuweisungen von dekorativen unterscheiden</li>
        </LearningGoals>
      </div>
      ...
      <section className="max-w-2xl mx-auto px-4 pb-12 sm:px-6">
        ...
        <TheoryCard title="Drei Strategien für Farbhierarchie">
  ...
  <div style="flex: 1; background: #f8fafc; padding: 20px;">
    ...
    <button style="background: #dc2626; color: white; padding: 8px 14px; border-radius: 8px; font-size: 12px; font-weight: 600; border: none; cursor: default;">Konto löschen</button>
      ...
      <section className="max-w-2xl mx-auto px-4 pb-12 sm:px-6">
        <CodeBlock
          language="html"
          title="HTML + CSS — Aufgabe Modul 15"
          code={`<!-- Modul 15 — Praxisaufgabe: Farbhierarchie -->
<!-- Schaffe eine klare Hierarchie: Primary / Secondary / Tertiary -->
...
<style>
  ...
  .settings-sidebar {
    width: 160px;
    background: #1e293b;     /* TODO: Zu dominant */
    padding: 16px;
  }
  ...
  .badge-verified {
    background: #dcfce7;   /* TODO: Braucht das Farbe? */
    color: #166534;
  }
  .badge-plan {
    background: #dbeafe;   /* TODO: Braucht das Farbe? */
    color: #1e40af;
  }

  .btn-save {
    background: #0ea5a0;   /* Primary — bleibt */
    color: #fff;
  }
  .btn-photo {
    background: #3b82f6;   /* TODO: Secondary machen */
    color: #fff;
  }
  .btn-password {
    background: #8b5cf6;   /* TODO: Secondary/Tertiary */
    color: #fff;
  }
  .btn-delete {
    background: #dc2626;   /* TODO: Tertiary-Style */
    color: #fff;
  }
</style>
...
<div class="settings-page">
  ...
  <div class="settings-main">
    ...
    <div class="actions">
      ...
      <button class="btn-photo">Bild ändern</button>
      <button class="btn-password">Passwort</button>
    </div>
    <button class="btn-delete">Konto löschen</button>
  </div>
</div>`}
        />
      </section>
