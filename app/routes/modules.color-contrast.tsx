...
<style>
  ...
  .profile-role {
    font-size: 13px;
    color: #a0a0a0;   /* TODO: Grau auf Blau — schlecht! */
  }
  ...
  .dot-online  { background: #22c55e; } /* TODO: Nur Farbe — nicht genug */
  .dot-overdue { background: #ef4444; } /* TODO: Nur Farbe — nicht genug */
  ...
  .tag-react      { background: #e0e7ff; color: #6366f1; }
  .tag-typescript { background: #fce7f3; color: #ec4899; }
  .tag-css        { background: #d1fae5; color: #10b981; }
  /* TODO: Prüfe den Kontrast jeder Tag-Farbe */
</style>

<div class="profile-card">
  <div class="profile-header">
    <div class="profile-name">Maria Lehmann</div>
    <div class="profile-role">Senior Frontend Developer</div>
  </div>
  <div class="profile-body">
    <div class="status-row">
      ...
      <div class="status-item">
        <span class="dot dot-overdue"></span> 3 Tasks überfällig
      </div>
    </div>
    <div class="tag-row">
