...
import { findIcon } from "./icon-catalog";
import type { IconOverride, IconOverrideMap } from "./types";
 ...
 * to specific elements. Icons are real Lucide icons but each carries a
 * stable `data-pp-icon-id` so the inspector can replace them.
 */
...
export const Dashboard = forwardRef<HTMLDivElement, DashboardProps>(function Dashboard(
    ...
    // Render helper — resolves the icon (name/size/stroke/variant) from overrides.
    const I = (id: string, defaults: IconOverride) => (
        <DIcon id={id} defaults={defaults} overrides={iconOverrides} />
    );
        ...
        <div className="pp-dashboard" ref={ref}>
            ...
            <header className="d-header" data-pp-role="header">
                <div className="d-header-left">
                    <div className="d-logo" data-pp-role="logo">
                        {I("logo", { name: "sparkles", size: 22, strokeWidth: 2, variant: "stroke" })}
            ...
            <aside className="d-sidebar" data-pp-role="sidebar">
                <div className="d-nav-section">
                    ...
                    <ul className="d-nav">
                        <li className="d-nav-item d-nav-item--active" data-pp-role="nav-item-active">
                            {I("nav-overview", { name: "layout-dashboard", size: 16, strokeWidth: 2, variant: "stroke" })}
                            <span>Overview</span>
                        </li>
                        <li className="d-nav-item" data-pp-role="nav-item">
                            {I("nav-reports", { name: "file-text", size: 16, strokeWidth: 2, variant: "stroke" })}
                            <span>Reports</span>
                        </li>
                        <li className="d-nav-item" data-pp-role="nav-item">
                            {I("nav-funnels", { name: "funnel", size: 16, strokeWidth: 2, variant: "stroke" })}
                            <span>Funnels</span>
                        </li>
                        <li className="d-nav-item" data-pp-role="nav-item">
                            {I("nav-segments", { name: "layers", size: 16, strokeWidth: 2, variant: "stroke" })}
                            <span>Segments</span>
                        </li>
                        <li className="d-nav-item" data-pp-role="nav-item">
                            {I("nav-experiments", { name: "target", size: 16, strokeWidth: 2, variant: "stroke" })}
                ...
                <div className="d-nav-section">
                    ...
                    <ul className="d-nav">
                        <li className="d-nav-item" data-pp-role="nav-item">
                            {I("nav-data", { name: "database", size: 16, strokeWidth: 2, variant: "stroke" })}
                            <span>Data sources</span>
                        </li>
                        <li className="d-nav-item" data-pp-role="nav-item">
                            {I("nav-integrations", { name: "share-2", size: 16, strokeWidth: 2, variant: "stroke" })}
                            <span>Integrations</span>
                        </li>
                        <li className="d-nav-item" data-pp-role="nav-item">
                            {I("nav-team", { name: "users", size: 16, strokeWidth: 2, variant: "stroke" })}
                            <span>Team</span>
                        </li>
                        <li className="d-nav-item" data-pp-role="nav-item">
                            {I("nav-settings", { name: "settings", size: 16, strokeWidth: 2, variant: "stroke" })}
                            <span>Settings</span>
                        </li>
                    </ul>
                </div>
            ...
            <main className="d-main" data-pp-role="main">
                <div className="d-page-head" data-pp-role="page-head">
                    ...
                    <div style={{ display: "flex", gap: "var(--d-space-2)" }}>
                        ...
                        <button type="button" className="d-btn d-btn--primary" data-pp-role="btn-primary">
                            {I("btn-new", { name: "plus", size: 14, strokeWidth: 2, variant: "stroke" })}
                ...
                <section className="d-kpis" data-pp-role="kpi-row">
                    {[
                        { id: "kpi-revenue", label: "Monthly revenue", value: "$128,430", delta: "+12.4% vs last month", icon: "dollar-sign" },
                        { id: "kpi-users", label: "Active users", value: "42,871", delta: "+3.1% vs last month", icon: "users" },
                        { id: "kpi-conv", label: "Conversion rate", value: "4.82%", delta: "−0.3% vs last month", icon: "trending-up" },
                ...
                <section className="d-grid-row" data-pp-role="grid-row">
                    <article className="d-card" data-pp-role="card">
                        <div className="d-card-head">
                            ...
                            {I("card-sessions-ico", { name: "activity", size: 16, strokeWidth: 2, variant: "stroke" })}
                        </div>
                        <Sparkline />
                    </article>
                    ...
                    <article className="d-card" data-pp-role="card">
                        <div className="d-card-head">
                            ...
                            {I("card-goals-ico", { name: "target", size: 16, strokeWidth: 2, variant: "stroke" })}
                        </div>
                    ...
                    <article className="d-card" data-pp-role="card">
                        <div className="d-card-head">
                            ...
                            {I("card-activity-ico", { name: "bell", size: 16, strokeWidth: 2, variant: "stroke" })}
                        </div>
                ...
                <section className="d-card" data-pp-role="card">
                    <div className="d-card-head">
                        ...
                        <button type="button" className="d-btn" data-pp-role="btn-secondary">
                            <span>View all</span>
                            {I("table-more", { name: "arrow-right", size: 14, strokeWidth: 2, variant: "stroke" })}
                        </button>
                    </div>
...
/* ── DIcon — the editable icon component ────────────────── */

function DIcon({
    id, defaults, overrides,
}: {
    id: string;
    defaults: IconOverride;
    overrides: IconOverrideMap;
}) {
    const resolved = { ...defaults, ...(overrides[id] ?? {}) };
    const Icon = findIcon(resolved.name) ?? findIcon(defaults.name);
    if (!Icon) return null;
    const isFill = resolved.variant === "fill";
    return (
        <Icon
            className="d-icon"
            data-pp-icon-id={id}
            data-pp-icon-defaults={JSON.stringify(defaults)}
            size={resolved.size}
